            ...
            Wrap(
              children: [
                ...uploadedImageUrls.asMap().entries.map((entry) => Padding(
                      ...
                      child: Stack(
                        children: [
                          Image.network(entry.value, width: 100, height: 100),
                          Positioned(
                            right: 0,
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      File? imageFile = await getImageFromUser();
                      if (imageFile != null) {
                        setState(() {
            ...
            Padding(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  ...
                  var adsauto = AdsFireStore(selectedTag!,selectedTransport!,_nameController.text,int.tryParse(_priceController.text)!,_addressController.text,int.tryParse(_yearController.text)!,int.tryParse(_mileageController.text)!,uploadedImageUrls);
